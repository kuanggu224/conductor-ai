...
- 针对测试：`python -m pytest tests\test_replay_verifier.py -q`，结果 `14 passed`。
...
- 针对测试：`python -m pytest tests\test_replay_trace.py tests\test_replay_verifier.py -q`，结果 `19 passed`。
...
- 当前全量测试：`python -m pytest -q`，结果 `399 passed`。
